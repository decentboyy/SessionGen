...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@CodeNexus_community"))
        else:
            ...
            await client.join_chat("CodeNexus_community")
    except KeyError:
        pass
    try:
